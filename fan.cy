...
// Tags are probably not the nicest solution, but objc_allocateClassPair explodes in cycript for some reason :(
...
function highlight(view) {
    ...
    highlight = [[UIView alloc] initWithFrame:view.bounds];
